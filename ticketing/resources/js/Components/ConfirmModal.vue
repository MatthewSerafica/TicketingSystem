  ...
  <div class="custom-modal" @close="closeSubmitService">
    <div class="modal-content">
            ...
            <div class="card-body row">
              <div class="col-md-6">
                ...
                <div class="text">
                  ...
                  <p class="card-text">
                    <strong>Date Started:</strong> {{ formattedDate(form.date_started) ?? "Not available" }}
                  </p>
                  <p class="card-text">
                    <strong>Time Started:</strong> {{ form.time_started ?? "Not available" }}
                  </p>
                  <p class="card-text">
                    <strong>Ticket Number:</strong> {{ form.ticket_number ?? "Not available" }}
                  </p>
                  <p class="card-text">
                    <strong>Technician Name:</strong> {{ form.technician ?? "Not available" }}
                  </p>
                  <p class="card-text">
                    <strong>Requesting Office:</strong> {{ form.requesting_office ?? "Not available" }}
                  </p>
                  <p class="card-text">
                    <strong>Equipment, Property Tag/Serial No.:</strong> {{ form.equipment_no ?? "Not available" }}
                  </p>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="text">
                  ...
                  <p class="card-text"><strong>Date Done:</strong> {{ formattedDate(form.date_done) ?? "Not available"
                    }}
                  </p>
      ...
      <div class="modal-footer justify-content-end d-flex gap-2">
        <Button :name="'Confirm Submission'" class="btn btn-primary" @click="submitServiceReport">Confirm
          Submission</Button>
