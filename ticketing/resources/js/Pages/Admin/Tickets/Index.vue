          ...
          <table class="table table-hover shadow custom-rounded-table">
            ...
            <tbody>
              <tr v-for="ticket in tickets.data" :key="ticket.ticket_number" class="align-middle">
                ...
                <td class="text-center" @click="showInput(ticket.rr_no, ticket.ticket_number, 'rr')">
                ...
                <td class="text-center" @click="showInput(ticket.ms_no, ticket.ticket_number, 'ms')">
                ...
                <td class="text-center" @click="showInput(ticket.rs_no, ticket.ticket_number, 'rs')">
