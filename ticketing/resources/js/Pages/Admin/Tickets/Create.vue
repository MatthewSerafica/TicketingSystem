        ...
        <div class="create-ticket">
          <div class="d-flex flex-row gap-5 justify-content-center mb-4">
            ...
            <div class="d-flex flex-column flex-shrink-0 w-25">
              ...
              <select id="department" class="form-select h-100 rounded border-secondary-subtle" placeholder="Select Department..."
            ...
            <div class="d-flex flex-column flex-shrink-0 w-25">
              ...
              <select id="service" class="form-select h-100 rounded border-secondary-subtle" placeholder="Assign Technician..."
          ...
          <div class="d-flex flex-row gap-5 justify-content-center mb-4">
            <div class="d-flex flex-column flex-shrink-0 w-25">
              ...
              <input id="description" class="form-control h-100 rounded border-secondary-subtle" type="text" placeholder="Enter Ticket Description..."
                v-model="form.description" />
            </div>
            <div class="d-flex flex-column flex-shrink-0 w-25">
              <label for="service" class="fw-semibold">Service</label>
              <select id="service" class="form-select h-100 rounded border-secondary-subtle" placeholder="Select Service..."
