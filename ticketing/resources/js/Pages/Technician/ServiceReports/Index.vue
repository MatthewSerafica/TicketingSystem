    ...
    <div class="text-center justify-content-center align-items-center d-flex mt-5 flex-column">
      ...
      <div class="container text-center w-100 h-100 justify-center">
        ...
        <div class="d-flex gap-2">
          <Link :href="route('technician.service-report.create')" class="btn btn-tickets btn-primary py-2 px-5">Create New
          Reports </Link>
        ...
        <div class="input-group mt-3 mb-4">
          ...
          <input type="text" class="form-control py-2" id="search" name="search" v-model="search"
            placeholder="Search Reports..." aria-label="searchIcon" aria-describedby="searchIcon" />
        </div>
      </div>
