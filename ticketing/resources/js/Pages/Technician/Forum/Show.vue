        ...
        <div>
            <div class="container justify-content-center mt-4 col-6">
                <div class="row">
                    <div class="pb-2 d-flex flex-column gap-2">
                        <div class="post rounded p-2">
                            <div class="d-flex align-items-center gap-2">
                                <div class="d-flex align-items-center justify-content-center gap-2" style="margin-left: -2.5rem;">
                                    <div>
                    ...
                    <div class="pb-2 d-flex flex-column" v-for="comment in comments" v-bind:key="comment.id">
                        <div class="post rounded p-2">
                            <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="">
                                ...
                                <div class="d-flex justify-content-start align-items-center text-dark gap-2"
                                ...
                                <div v-if="isShowReply && selectedComment && selectedComment === comment.id"
                                    ...
                                    <form @submit.prevent="reply(comment.id)">
                                        <textarea ref="commentTextarea" class="p-2 px-4 rounded-4 form-control border-0"
                                            v-model="commentForm.content"></textarea>
                        ...
                        <div v-for="reply in replies" v-bind:key="reply.id" class="mx-5">
                            <div v-if="reply.parent_comment_id === comment.id" class="post rounded">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="d-flex align-items-center justify-content-center gap-2">
                                        <div class="mt-3 d-flex align-items-center gap-2">
                                            <p class="fw-semibold text-dark"><small>{{ reply.user.name }}</small></p>
                                            <p class="text-secondary">
                                                •
                                            </p>
                                            <p class="text-secondary"><small>{{ reply.time_since_posted }}</small></p>
                                        </div>
                                    </div>
                                </div>
